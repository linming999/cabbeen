package com.kabin.common.utils.file;
...
import com.kabin.common.exception.file.FileNameLengthLimitExceededException;
import com.kabin.common.exception.file.FileSizeLimitExceededException;
import com.kabin.common.exception.file.InvalidExtensionException;
import com.kabin.common.utils.DateUtils;
import com.kabin.common.utils.StringUtils;
import com.kabin.common.utils.uuid.IdUtils;
import com.kabin.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = KaBinConfig.getProfile();
    ...
    {
        int dirLastIndex = KaBinConfig.getProfile().length() + 1;
